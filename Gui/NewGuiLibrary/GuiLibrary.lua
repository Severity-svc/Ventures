...
if RunService:IsStudio() then
	...
	for _, filePath in pairs({FileBranch.Toggles, FileBranch.Sliders, FileBranch.Colors, FileBranch.Keybinds, FileBranch.Dropdowns, FileBranch.Inputs}) do
...
local Window, SettingsAssync = Library:CreateWindow({
	Title = "Ventures.lua | Rivals",
...
do
	...
	local SelfVisuals = Window:CreateTab({
		Name = "Self Visuals",
		Icon = "eye off",
	})
	...
	local Aimbot = Utility:CreateToggle({
		Name = "Aimbot",
		Description = "Automatically Aims At The Zombies.",
		Default = false,
		Flag = "Aimbot",
	...
	local Aim2bot = Utility:CreateToggle({
		Name = "Aimbo22t",
		Description = "Automatically Aims At The Zombies.",
		Default = false,
		Flag = "Aimbot",
	...
	local Aimb2ot = Utility:CreateToggle({
		Name = "Aimbo2t",
		Description = "Automatically Aims At The Zombies.",
		Default = false,
		Flag = "Aimbot",
	...
	local ChatSpamText = Utility:CreateInput({
		Name = "Chat Spammer Text",
		Description = "The text you want to spam",
		Default = ".g>g/v3n",
	...
	local HitboxExpanderSection = Utility:CreateSection({Title = "Hitbox Expander"})

	local HitboxHitpart = Utility:CreateDropdown({
		Name = "Expanding Part",
		Description = "Changes The Hitbox Expanding Parts",
		Values = {"All Parts","Head","Torso"},
		Multi = false,
		Default = 1,
		Flag = "HitboxHitpart",
		Callback = function(Value)
	...
	local UnstoreAll = Utility:CreateButton({
		Name = "Unstore All Items", 
		Description = "Unstores All Of Your Items From The Sack",
		Default = false,
...
do
	...
	SettingsAssync:StartupSettings()
	local StatsUI = Library:CreateStatUi()
	StatsUI:SetVisibility(true)

	local PlayersCount = StatsUI:CreateStat({
		StatName = "Players: ",
		Value = "0",
	})

	local ItemsCount = StatsUI:CreateStat({
		StatName = "Items: ",
		Value = "0",
	})

	local EnemiesCount = StatsUI:CreateStat({
		StatName = "Enemies: ",
		Value = "0",
	})

	local CorpsesCount = StatsUI:CreateStat({
		StatName = "Corpses: ",
		Value = "0",
	})

	local HealthNum = StatsUI:CreateStat({
		StatName = "Health: ",
		Value = "0",
	})

	local TrainFuel = StatsUI:CreateStat({
		StatName = "Fuel: ",
		Value = "0",
	})

	local MoneyNum = StatsUI:CreateStat({
		StatName = "Money: ",
		Value = "0",
		BackgroundTransparency = 0.45,
		BackgroundColor = Color3.fromRGB(39, 9, 34),
	})

	local MetersNum = StatsUI:CreateStat({
		StatName = "Meters: ",
		Value = "0",
		BackgroundTransparency = 0.45,
	...
	local RunningTime = StatsUI:CreateStat({
		StatName = "Play Time: ",
		Value = "0",
		BackgroundTransparency = 0.45,
		BackgroundColor = Color3.fromRGB(85, 86, 0),
		StrokeColor = Color3.fromRGB(149, 149, 0),
		StrokeTransparency = 0,
		ValueColor = Color3.fromRGB(250, 255, 202),
		NameColor = Color3.fromRGB(250, 255, 202),
	})
end
